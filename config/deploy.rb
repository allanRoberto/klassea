...
set :scm, :git
set :repository,  "git@github.com:allanRoberto/klassea.git" 
# set :scm, :subversion
...
set :local_path, "/Users/Allan/Sites/klassea" 
...
set :local_domain, 'klassea.art.com.br'
